...
![A simulation test of YAGSL's new SwerveInputStream.aim lookahead targeting, showing the robot pose tracking a moving target vector](../../assets/blog/yagsl-aim-test.png)
...
Also, since it comes up: YASS is free and will always be free. If you want to support the work, donations go toward things like the stickers we hand out at events, not toward gating any library behind a paywall.

![Support YASS graphic promoting donations that go toward event stickers, not toward gating any library behind a paywall](../../assets/blog/yass-donation-support.png)
